 ...
 *
 * Based on code by Joshua Hug.
 */
public class PrintHeapDemo {

    /**
     * Prints out a very basic heap drawing of the given list of Objects.
     * Specify startIndex to be the index containing the first item of the heap.
    ...
    /**
     * Prints out a heap drawing of the given list of Objects that starts at the given index.
     * Specify startIndex to be the index containing the first item of the heap.
